...
public class UserTeacherActivity extends AppCompatActivity {
    ...
    private final String data[][] = {{"创建课程", ""}};
    ...
    protected void onCreate(Bundle savedInstanceState) {
                        ...
                        Dialog dialog = new AlertDialog.Builder(UserTeacherActivity.this)
                                ...
                                .setPositiveButton("Sure", new DialogInterface.OnClickListener() {
                                    ...
                                    public void onClick(DialogInterface dialogInterface, int i) {
                                        ...
                                        Intent intent = new Intent(UserTeacherActivity.this,Login.class);
        ...
        map.put("pic_name", String.valueOf(UserTeacherActivity.this.pic[0]));
        map.put("_name", UserTeacherActivity.this.data[0][0]);
        map.put("author", UserTeacherActivity.this.data[0][1]);
        UserTeacherActivity.this.list.add(map)；

        if(creatFlag == 1){
            map = new HashMap<String ,String>();
            map.put("pic_name", String.valueOf(UserTeacherActivity.this.pic[0]));
            map.put("_name", UserTeacherActivity.this.getLocalname());
            map.put("author", UserTeacherActivity.this.getLocalteachername());
            UserTeacherActivity.this.list.add(map);
        }


        /*UserTeacherActivity.this.simpleAdapter = new SimpleAdapter(UserTeacherActivity.this, UserTeacherActivity.this.list,
                R.layout.teacherlistview_style, new String[]{"pic_name", "_name", "author"}, new int[]{R.id.pic_name, R.id._name, R.id.author});
        UserTeacherActivity.this.teacherlistviwe.setAdapter(simpleAdapter);


        /*this.teacherlistviwe.setOnItemClickListener(new AdapterView.OnItemClickListener() {
            @Override
            public void onItemClick(AdapterView<?> adapterView, View view, int i, long l) {

                if (i == 0) {
                    Intent intent = new Intent(UserTeacherActivity.this, ClassnumberActivity.class);
                    startActivity(intent);
                    finish();
                }else{
                    Intent intent = new Intent(UserTeacherActivity.this,Commit.class);
                    startActivity(intent);
                }
            }
        });*/
