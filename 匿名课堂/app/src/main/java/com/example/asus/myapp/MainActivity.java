...
public class MainActivity extends AppCompatActivity implements SwipeRefreshLayout.OnRefreshListener {
    ...
    //private String dataInfo[][] = new String[1][2];
    ...
    private int pic[] = {R.drawable.nomal};
    private final String data[][] = {{"算法设计与分析", "井抄"}};
        ...
        public void handleMessage(Message msg) {
            switch (msg.what) {
                case 1:
                    ...
                    map.put("pic_name", String.valueOf(MainActivity.this.pic[0]));
                    map.put("_name", MainActivity.this.getCourseName());
                    map.put("author", MainActivity.this.getTeacherName());
                    map.put("_nameId",saveId);
                    MainActivity.this.list.add(map);

                    MainActivity.this.simpleAdapter = new SimpleAdapter(MainActivity.this, MainActivity.this.list,
                            R.layout.listview_style, new String[]{"pic_name", "_name", "author","_nameId"}, new int[]{R.id.pic_name, R.id._name, R.id.author,R.id._nameId});
                ...
                case 2:
                    ...
                    map1.put("pic_name", String.valueOf(MainActivity.this.pic[0]));
                    map1.put("_name", MainActivity.this.getCourseName());
                    map1.put("author", MainActivity.this.getTeacherName());
                    map1.put("_nameId",saveId);
                    MainActivity.this.list.add(map1);
    ...
    private class UpdateUIBroadcastReceiver extends BroadcastReceiver {
        ...
        public void onReceive(Context context, Intent intent) {
            ...
            //Toast.makeText(MainActivity.this, "++++++"+getGroupId(), Toast.LENGTH_SHORT).show();

            //Toast.makeText(MainActivity.this, "MaintActivity 收到的广播   " + info, 1).show();
        ...
        if (loginFlag == 1) {
            ...
            new Handler().postDelayed(new Runnable() {
                ...
                public void run() {
                    ...
                    // TextView show_id = (TextView) courseListView.findViewById(R.id.course_id);
                    // String tempid = show_id.getText().toString();
                    //Toast.makeText(MainActivity.this, tempid, Toast.LENGTH_SHORT).show();
                    ...
                    /*if(getGroupId()!= null) {
                        ...
                        for (int x = 0; x < courseListView.getCount(); x++) {
                            ...
                            //Toast.makeText(MainActivity.this, tempid, 1).show();
    ...
    private void initData() {
        ...
        /*testData.add(new Course("allen", "math", R.drawable.head1));
        testData.add(new Course("allen", "math", R.drawable.head1));
        testData.add(new Course("allen", "math", R.drawable.head1));*/
    }
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        if (1 == join) {
            ...
            Map<String, String> map = new HashMap<String, String>();
            map.put("pic_name", String.valueOf(MainActivity.this.pic[0]));
            map.put("_name", MainActivity.this.data[0][0]);
            map.put("author", MainActivity.this.data[0][1]);
            MainActivity.this.list.add(map);


            MainActivity.this.simpleAdapter = new SimpleAdapter(MainActivity.this, MainActivity.this.list,
                    R.layout.listview_style, new String[]{"pic_name", "_name", "author"}, new int[]{R.id.pic_name, R.id._name, R.id.author});
            MainActivity.this.datalist.setAdapter(simpleAdapter);
...
//参数6：having条件
//参数7：排序方式
            Cursor cursor = db.query(getDatabaseName(), new String[]{"_name", "author", "_nameId", "flag"}, null, null, null, null, null);
...
//关闭数据库
    ...
    public void showAppNotification(){
        ...
        nm.notify(Notification_ID_BASE, notification);
                            ...
                            /*//新建状态栏通知
                            baseNF = NotificationCompat.Builder();
    ...
    //public void setFlag(int loginFlag) {
    //   this.loginFlag = loginFlag;
    //}
    ...
    public boolean CheckId(String saveId) {
...
//参数6：having条件
//参数7：排序方式
        Cursor cursor = db.query(getDatabaseName(), new String[]{"_nameId"}, null, null, null, null, null);

        while (cursor.moveToNext()) {

            String _nameId = cursor.getString(cursor.getColumnIndex("_nameId"));

            if (_nameId.equals(saveId)) {
                return true;
            }
        }
//关闭数据库
    ...
    public void InsertSystemDate(String mgsBody , String Hour , String Min ){
        if (mgsBody == null) {
           ...
           // event.put(CalendarContract.Events.EVENT_END_TIMEZONE, "Asia/Shanghai");
