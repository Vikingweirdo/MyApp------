...
public class Login extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        ArrayAdapter<CharSequence> adapter = ArrayAdapter.createFromResource(Login.this,R.array.people,android.R.layout.simple_spinner_item);
        ...
        this.login.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                ...
                if ("".equals(name) && "".equals(pass)) {
                     ...
                     */
                    //} else if (Login.this.registerTeacher.getLoginFlag() == 1) {
                        //Intent intent = new Intent(Login.this, UserTeacherActivity.class);
                        //startActivity(intent);
                        //finish();
                        /*PostThread postThread = new PostThread(name, pass);
                        ...
                        //注册老师
                    //} else {
                        //Toast.makeText(Login.this, "不存在此用户,请先注册", Toast.LENGTH_SHORT).show();
                    //}
                }
